...
public		class		Player				: MonoBehaviour {
	...
	private		static readonly		float		MOVE_Z_BACK				= -15.0f;	//後退の速度
 ...
 */
	...
	private		void	CheckMove() {
		...
		//移動
		//addPosition	= Vector3.zero;		//移動量(z の値はメカニムにも渡す)
		{
			/*
			...
			//キー操作から移動する量を取得
			Vector3	vecInput		= new Vector3( 0f, 0, Input.GetAxisRaw( "v"));		//Zに前後の入力を入れます(Wキー、Sキー、ゲームパッドの入力など)
